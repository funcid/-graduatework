...
public class DbUtil {
    ...
    public static final String CREATE_TABLE_APPLICATIONS = "CREATE TABLE IF NOT EXISTS applications (id INT AUTO_INCREMENT, uuid TEXT, name TEXT, surname TEXT, secondName TEXT, email TEXT, description TEXT, date TIMESTAMP, category TEXT, PRIMARY KEY (id));";
    ...
    public static final String CREATE_APPLICATION = "INSERT INTO applications (uuid, name, surname, secondName, email, description, date, category) VALUES(?, ?, ?, ?, ?, ?, ?, ?);";
